      ...
      <div class="nav-collapse collapse navbar-responsive-collapse">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
          	...
          	<ul class="dropdown-menu">
          		<li><a href="public-list-routes.php"><i class="icon-info-sign icon-white"></i> View All Bus Routes</a></li>
          		<!-- <li><a href="#"><i class="icon-search icon-white"></i> Search for Bus Route</a></li> -->
          		<li class="divider"></li>
          		<li><a href="public-list-stops.php"><i class="icon-info-sign icon-white"></i> View All Stops</a></li>
          ...
          <li class="dropdown">
          	...
          	<ul class="dropdown-menu">
          		<li><a href="public-list-buses.php"><i class="icon-info-sign icon-white"></i> View All Buses</a></li>
          		<!-- <li><a href="#"><i class="icon-search icon-white"></i> Search for Bus</a></li> -->
          		<li class="divider"></li>
          		<li><a href="public-list-bus-personnel.php"><i class="icon-info-sign icon-white"></i> View All Personnel</a></li>
          ...
          <li class="dropdown">
          	...
          	<ul class="dropdown-menu">
          		<li><a href="public-list-complaints.php"><i class="icon-info-sign icon-white"></i> View All Complaints</a></li>
          		<li><a href="public-create-complaint.php"><i class="icon-plus icon-white"></i> Add Complaint</a></li>
          		<li class="divider"></li>
          		<li><a href="public-list-feedback-items.php"><i class="icon-info-sign icon-white"></i> View Feedback Provided</a></li>
          		<li><a href="public-create-feedback.php"><i class="icon-plus icon-white"></i> Provide Feedback</a></li>
          	</ul>
          </li>
          <?php } } ?>
          ...
          <li class="dropdown">
          	...
          	<ul class="dropdown-menu">
                <li><a href="user-manual.php">How to use Gaman</a></li>
                <li><a href="survey-info.php">Survey Info</a></li>
                <li><a href="test.php">Test</a></li>
          	</ul>
          </li>

          <!--
          <li<?php if (!empty($page) && $page == 'user_manual'){echo ' class="active"';}?>><a href="user-manual.php">How to use Gaman</a></li>
          <li<?php if (!empty($page) && $page == 'survey_info'){echo ' class="active"';}?>><a href="survey-info.php">Survey Info</a></li>
        ...
        -->
          ...
          if (!empty($session->id) && $session->object_type == 6) { // object_type 6 commuter
          	...
          	<ul class="dropdown-menu">
          		<li><a href="public-view-profile.php"><i class="icon-info-sign icon-white"></i> View Profile</a></li>
